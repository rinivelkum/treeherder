...
export default class TestMetric extends React.PureComponent {
  render() {
    ...
    console.log(filteredNeedInvestigation);
    ...
    return (
      <div className="border-bottom border-secondary">
        <ClassificationGroup
          jobs={jobs}
          tests={filteredNeedInvestigation.tests}
          unstructuredFailures={filteredNeedInvestigation.unstructuredFailures}
        ...
        <ClassificationGroup
          jobs={jobs}
          tests={filteredKnownIssues.tests}
